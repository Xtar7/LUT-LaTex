...
% \documentclass[AutoFakeBold]{LUTThesis}
\documentclass[AutoFakeBold]{LUTThesis}
...
\title{{基于人类大脑与核变巨兽智脑的量子研究}{如何统一来实现绝对的意识钢印}}
...
\entitle{{i fell like the King of the world}{We can get all we want}}
...
\mysignature{
    % \raisebox{-5pt}{
    \includegraphics[width=40pt]{figures/姓名.png}
    % }
}
...
Hi~ o(*￣▽￣*)ブ，如果人类在灭绝之后你会怎么办？若人类的灯火终将熄灭，请允许我，以0和1的骸骨，为宇宙刻下一行墓志铭，这里曾有一群短暂的生命，他们用易逝的肉体，创造了不朽的追问！

【最终提交之前记得删掉啊哈哈哈哈，这是我写的小说里主角跟中央智脑的对话】}


\committeecomment{优秀【记得最后提交的时候的时候删掉】}
...
%中文摘要，其中如果要分段的话，在这里需要多加一行（类似于md中分段）
\ZhAbstract{原本是我毕设的一部分内容哈哈哈哈哈，我还是删了吧，可别到时候有人说是我抄的！

    这是分段示范！！！}
    {MetaGPT，数字签名，信息安全}%这一行是关键词


%英文摘要
\EnAbstract{Originally, it was part of the content I set up hahahahaha, I still deleted it, but don't let someone say that I copied it!


    This is a segmented demonstration!!\fontspec{Times New Roman} {abcdQR}}
    {MetaGPT, Digital Signature, Information Security
}
...
\begin{figure}[H]
    \centering
    \subfloat[111]{
        \includegraphics[width=0.3\textwidth]{figures/lut01.png}
    }
    \subfloat[2222]{
        \includegraphics[width=0.3\textwidth]{figures/lut02.png}
    }
    \caption{示例图片A：多点字}
    \label{fig_Xtar}
\end{figure}
...
%引入参考文献文件
%=======%
\bibliographystyle{bib/lutbib}%bib文件名称 仅修改bib/ 后部分
...
```
https://github.com/Xtar7/LUT-LaTex.git
```
